...
export default function AboutPage() {
  ...
  return (
    <section className="pt-28 pb-20 min-h-screen" dir={dir}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {[
            { icon: Target, title: "about.mission", text: "about.mission_text", color: "emerald" },
            { icon: Eye, title: "about.vision", text: "about.vision_text", color: "green" },
            { icon: Heart, title: "about.values", text: "about.values_text", color: "lime" },
          ].map((item, i) => (
            <motion.div
              key={i}
              initial={{ opacity: 0, y: 30 }}
              ...
              className="bg-white rounded-3xl p-8 shadow-lg shadow-black/5 text-center"
            >
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-gradient-to-br from-emerald-700 to-green-700 rounded-3xl p-12 text-center"
        >
