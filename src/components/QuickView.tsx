...
export default function QuickView({ product, isOpen, onClose }: QuickViewProps) {
  ...
  return (
    <>
      ...
      {/* Modal — CSS scale + opacity transition */}
      <div
        className={`fixed inset-4 md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-[900px] md:max-h-[80vh] bg-[#111] rounded-2xl border border-[#2a2a2a] z-[90] overflow-hidden flex flex-col md:flex-row will-change-transform ${
          isOpen ? "modal-scale-in" : "modal-scale-out"
        }`}
        dir={dir}
      >
        {/* Close button */}
