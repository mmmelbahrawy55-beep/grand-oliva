        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <motion.div style={{ y: textY }}>
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2.5 border border-[#c9a96e]/20 rounded-full px-5 py-2.5 mb-8 sm:mb-10 bg-[#c9a96e]/[0.03] backdrop-blur-sm"
            >
              <motion.div
            ...
            <h1 className="mb-6 sm:mb-8">
              <motion.div className="overflow-hidden">
                <motion.span
                  ...
                  className="block text-5xl sm:text-7xl md:text-8xl lg:text-[7rem] font-bold text-white leading-[0.9] tracking-tight"
              ...
              <motion.div className="overflow-hidden mt-1">
                <motion.span
                  ...
                  className="block text-5xl sm:text-7xl md:text-8xl lg:text-[7rem] font-bold leading-[0.9] tracking-tight text-shimmer"
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  Oliva
                </motion.span>
            ...
            <motion.div
              ...
              className="h-[2px] bg-gradient-to-r from-[#c9a96e] to-transparent mb-6 sm:mb-8"
            />
            ...
            <motion.p
              ...
              className="text-lg sm:text-xl md:text-2xl text-[#c9a96e]/80 mb-4 sm:mb-6 font-light tracking-wide"
            >
            ...
            <motion.p
              ...
              className="text-gray-400 text-sm sm:text-base md:text-lg mb-8 sm:mb-12 max-w-lg leading-relaxed"
            >
              {locale === "ar"
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row gap-3 sm:gap-5 mb-10 sm:mb-14"
            >
              <Link
                href="/products"
                className="group magnetic-btn relative overflow-hidden px-8 sm:px-10 py-4 sm:py-5 rounded-2xl text-base font-semibold inline-flex items-center justify-center gap-3 w-full sm:w-auto text-center bg-gradient-to-r from-[#c9a96e] to-[#b8985d] text-[#0a0a0a] shadow-[0_0_30px_rgba(201,169,110,0.3)] hover:shadow-[0_0_40px_rgba(201,169,110,0.5)] transition-shadow duration-500"
              >
              ...
              <Link
                href="/about"
                className="magnetic-btn border border-[#c9a96e]/25 text-[#c9a96e] px-8 sm:px-10 py-4 sm:py-5 rounded-2xl text-base font-semibold hover:bg-[#c9a96e]/[0.08] hover:border-[#c9a96e]/40 transition-all duration-500 w-full sm:w-auto text-center backdrop-blur-sm"
              >
            ...
            <motion.div
              ...
              className="flex flex-wrap justify-start gap-8 sm:gap-12 pt-8 sm:pt-10 border-t border-[#2a2a2a]/60"
            >
              {[
          ...
          >
            ...
            >
              ...
              <div className="relative w-[280px] h-[280px] sm:w-[340px] sm:h-[340px] md:w-[400px] md:h-[400px] lg:w-[460px] lg:h-[460px] rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden border border-[#c9a96e]/15 shadow-gold-glow">
                <motion.div
                ...
                <motion.div
                  ...
                  className="absolute top-4 right-4 sm:top-5 sm:right-5 bg-[#0a0a0a]/80 backdrop-blur-md border border-[#c9a96e]/25 rounded-xl sm:rounded-2xl px-3 py-2 sm:px-4 sm:py-3 shadow-premium"
                >
                  <div className="flex items-center gap-2">
                    <span className="text-base sm:text-lg">🏆</span>
                    <div>
                      <div className="text-[#c9a96e] text-[9px] sm:text-[10px] font-semibold tracking-wider uppercase">
                ...
                <motion.div
                  ...
                  className="absolute bottom-4 left-4 sm:bottom-5 sm:left-5 bg-[#0a0a0a]/80 backdrop-blur-md border border-[#c9a96e]/25 rounded-xl sm:rounded-2xl px-3 py-2 sm:px-4 sm:py-3 shadow-premium"
                >
                  <div className="flex items-center gap-2">
                    <span className="text-base sm:text-lg">🫒</span>
                    <div>
                ...
                <motion.div
                  ...
                  className="absolute inset-0 border border-[#c9a96e]/10 rounded-[1.5rem] sm:rounded-[2rem] pointer-events-none"
                />
              </div>
            </motion.div>
          </motion.div>
        ...
        >
          ...
          <div className="w-5 h-8 rounded-full border border-[#c9a96e]/20 flex items-start justify-center p-1.5">
            <motion.div
              ...
              className="w-1 h-1.5 rounded-full bg-[#c9a96e]/60"
            />
          </div>
        </motion.div>
      </motion.div>
